  ...
  "paths": {
        ...
        "parameters": [
          {
            ...
            "in": "path",
            "required": true,
            "description": "Username of the user that can be updated",
            "type": "string"
          }
        ],
        "requestBody": {
    ...
    "/api/auth/login": {
      "post": {
        ...
        "requestBody": {
          "description": "Users send username and password and for response we have jwt token",
          "content": {
            "application/json": {
              "schema": {
                "type": "object",
        ...
        "parameters": [
          {
            ...
            "in": "path",
            "required": true,
            "description": "Find user and prodcuts",
            "type": "string"
          }
        ],
        "responses": {
